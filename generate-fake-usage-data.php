...
// Supprimer les anciennes données d'historique (optionnel - décommenter si nécessaire)
// LicenceHistory::where('created_at', '>=', Carbon::now()->subDays(30))->delete();
...
for ($day = 30; $day >= 0; $day--) {
    ...
    // Générer un nombre aléatoire d'utilisations pour ce jour (entre 5 et 50)
...
echo "\nRafraîchissez votre tableau de bord pour voir le graphique mis à jour.\n";